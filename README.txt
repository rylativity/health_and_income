...
Modeling work can be found in the modeling_and_exploration notebook:
...
aggregated to the county level in order to include income.  Furthermore, because I had to aggregate health data, specific
